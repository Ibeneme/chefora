      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-12">
            ...
            >
              <img src={use} style={{width: 64, height: 64}}/>
            </a>
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <button
              className={`text-white ${primaryColor} font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-[1.02]`}
            >
              Sign Up
            </button>
          </div>
